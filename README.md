...
- See hover states for interactive elements _('change', 'Proceed to Payment', and 'Cancel Order' button)_

### Links

- Solution URL: [Open GitHub repository](https://github.com/YariMorcus/order-summary-component)
- Live Site URL: [open GitHub Pages of repository](https://yarimorcus.github.io/order-summary-component/)
...
4. How to implement the BEM _(Block Element Modifier)_ naming convention in a project, and how to write the SCSS with it
...
- [Frontend Mentor - Order summary component challenge](https://www.frontendmentor.io/challenges/order-summary-component-QlPmajDUj) 
